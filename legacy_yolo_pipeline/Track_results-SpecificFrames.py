...
# ==== CONFIG ====
video_path = "63/scene63.mp4"
model_path = "best-11-parasite-1219.pt"
gt_mask_folder = "63/scene63"
output_dir = "eval_results63-bytetracker-test"

starting_frame = 0   # first frame to process (inclusive, counting from 0)
ending_frame = 353     # last frame to process (inclusive)
...
def run_tracking_and_save_results(total_frames):
    """Run tracking for a specific frame range and save results in MOT format"""
    ...
    with open(results_file, "w", newline='') as res_file:
        ...
        for idx in range(total_frames):
            ...
            results = model.track(source=frame, tracker="custom-bytetrack.yaml", persist=True, device=device)
